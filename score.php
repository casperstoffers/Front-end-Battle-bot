		...
		if(isset($_POST["submit"])){
			...
			$ronde = $_POST["ronde_1"];
				...
				if (!empty($_POST["score"])){
																		...
																		$db = mysqli_connect("localhost", "root", "", "scoreboard");
																		if ($db == true)
																			{
																				echo "database connectie gemaakt<br>";
																				
																				echo "en je hebt een score op bot numeer " . $bot ." ingevoerd van  " . $score_1 . " <br>";
																				
																				$sql = "update score set score_". $ronde  ." = ". $score_1 ." where score.bot_id = "  . $bot ."";
																				...
																				$result = mysqli_query($db,$sql);
																						...
																						{
																							echo "geen database connectie kunnen maken";
																						}
				}else 
					{
						echo "vul score in";
